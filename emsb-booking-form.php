        ...
        <?php 
            ...
            if ($valid_customer_name && $valid_customer_email && $valid_customer_phone && $valid_service_id && $valid_service_name && $valid_booked_date_id && $valid_booked_slot_id && $valid_booked_date && $valid_booked_time_slot && $valid_emsb_booking_slot_starts_at ) {
                ...
                $emsb_insert_query = $wpdb->prepare("INSERT INTO $emsb_bookings_table_name 
                    ...
                    $emsb_bookings_availability_int - 1
                );
                ...
                if($emsb_insert_booking){
                   ...
                   $customer_mail_body = $customer_mail_body .'<br>' ."\r\n";
                    ...
                    $customer_mail_body .= ' <br>' ."\r\n";
                    $customer_mail_body .= 'Informações da solicitação:  <br>' ."\r\n";
                    $customer_mail_body .= 'Seu nome: ' . $customer_name_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Número de contato: ' . $customer_phone_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Seu endereço de E-mail: ' . $customer_email_address . '<br>' ."\r\n";
                    $customer_mail_body .= 'Médico escolhido: ' . $service_name_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Data escolhida: ' . $booked_date_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $customer_mail_body .= 'Horário escolhido: ' . $booked_time_slot_xss_proof_and_sanitized . '<br>' ."\r\n";
                    ...
                    $admin_email_Body .= ' <br>' ."\r\n";
                    $admin_email_Body .= ' <br>' ."\r\n";
                    $admin_email_Body .= 'Informações da Solicitação:  <br>' ."\r\n";
                    $admin_email_Body .= 'Nome do Paciente: ' . $customer_name_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $admin_email_Body .= 'Contato: ' . $customer_phone_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $admin_email_Body .= 'E-mail do Paciente: ' . $customer_email_address . '<br>' ."\r\n";
                    $admin_email_Body .= 'Médico: ' . $service_name_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $admin_email_Body .= 'Data solicitada: ' . $booked_date_xss_proof_and_sanitized . '<br>' ."\r\n";
                    $admin_email_Body .= 'Horário solicitado: ' . $booked_time_slot_xss_proof_and_sanitized . '<br>' ."\r\n"; 
                    ...
                    <div id="emsb_booking_ticket">
                        <div class="emsb-ticket-wrapper">
                            <div  class="text-center" >
                                <div class="emsb-pending-notification"> <?php _e( 'Solicitação Enviada:', 'emsb-service-booking' ); ?> 
                                    <span class="text-warning"> <?php _e( 'Em Análise', 'emsb-service-booking' ); ?> </span>
                                </div>
                            </div>
                            <div class="emsb-booked-service">
                                <div class="em-service-excerpt d-flex align-items-center">
                                    <div class="emsb-booked-service-info">
                                        <h4 id="emsb-service-name"> <?php _e( 'Médico: ', 'emsb-service-booking' ); ?> <?php echo $service_name_xss_proof_and_sanitized;?> </h4> 
                                        <p> <?php _e( 'Especialidades: ', 'emsb-service-booking' ); ?> <?php echo $service_title_xss_proof_and_sanitized; ?>  </p>
                                        <p> <?php echo $service_location_xss_proof_and_sanitized; ?> </p>
                                        <p class="em-reservation-service-price"> <?php _e( ' ', 'emsb-service-booking' ); ?> <b> <?php echo $service_price_xss_proof_and_sanitized; ?> </b> </p>  
                                    </div>
                                </div>
                            </div>
                            <div class="emsb-booking-info">
                                <h4> <?php _e( 'Informações do Agendamento ', 'emsb-service-booking' ); ?> </h4>
                                <div class="emsb-booked-id">
                                    <p><?php _e( 'ID da Solicitação: ', 'emsb-service-booking' ); ?> <?php echo $emsb_booking_id; ?></p>
                                </div>
                                <div class="emsb-booked-date d-flex align-items-center">
                                    <p class="emsb-date"> <?php _e( 'Data da Consulta: ', 'emsb-service-booking' ); ?> <?php echo $booked_date_xss_proof_and_sanitized; ?></p>
                                </div>
                                <div class="em-booked-time-slot d-flex align-items-center">
                                    <p class="emsb-time-slot"> <?php _e( 'Horário da Consulta: ', 'emsb-service-booking' ); ?> <?php echo  $booked_time_slot_xss_proof_and_sanitized; ?> </p>
                                </div>
                            </div>
                            <div class="emsb-booking-user-info">
                                <div class="d-flex align-items-center">
                                    <p class="emsb-user-name"> <?php _e( 'Nome do Paciente: ', 'emsb-service-booking' ); ?> <?php echo $customer_name_xss_proof_and_sanitized; ?></p>
                                </div>
                                <div class="d-flex align-items-center">
                                    <p class="emsb-user-phone"><?php _e( ' Telefone de Contato: ', 'emsb-service-booking' ); ?> <?php echo $customer_phone_xss_proof_and_sanitized; ?> </p>
                                </div>
                            </div>
                        </div>
                        <div class="emsb-ticket-button-wrapper">
                            <h4> <?php _e( 'Sua solicitação foi enviada, aguarde o E-mail de confirmação!', 'emsb-service-booking' ); ?></h4>
                            <button id="goBackButton" class="btn btn-dark emsb-ticket-button"> <?php _e( 'Finalizar Agendamento ', 'emsb-service-booking' ); ?></button>
                        </div>
                    </div>
                </div>
                <script>
            ...
            <?php
                ...
                <div class="emsb-booking-ticket-container text-left">
                    <div class="emsb-form-submission-error p-3">
                        <span> <?php _e( 'Verifique as informações e tente novamente', 'emsb-service-booking' ); ?></span>
                        <button id="goBackButton" class="btn btn-dark emsb-ticket-button"> <?php _e( 'Refazer Agendamento', 'emsb-service-booking' ); ?></button>
                    </div>
                </div>
        <?php    }
